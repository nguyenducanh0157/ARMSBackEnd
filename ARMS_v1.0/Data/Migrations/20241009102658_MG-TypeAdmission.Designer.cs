...
namespace Data.Migrations
{
    ...
    [Migration("20241009102658_MG-TypeAdmission")]
    partial class MGTypeAdmission
    {
            ...
            modelBuilder.Entity("Data.Models.Account", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            CampusId = "Hanoi",
                            ConcurrencyStamp = "bb0a9245-e726-49d9-8da5-f9993f436668",
                            ...
                            PasswordHash = "AQAAAAEAACcQAAAAED3g2sDCG+8Kn2cPiYyjPQOg24AStrB+CZ69rsKv2dq/ms2glavnBz9ZNtNJD6dW3A==",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "fd3751cb-6d43-4570-bc39-670b644f96ed",
            ...
            modelBuilder.Entity("Data.Models.Blog", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            DateCreate = new DateTime(2024, 10, 9, 17, 26, 57, 365, DateTimeKind.Local).AddTicks(5232),
                        ...
                        new
                        {
                            ...
                            DateCreate = new DateTime(2024, 10, 9, 17, 26, 57, 365, DateTimeKind.Local).AddTicks(5240),
                        ...
                        new
                        {
                            ...
                            DateCreate = new DateTime(2024, 10, 9, 17, 26, 57, 365, DateTimeKind.Local).AddTicks(5241),
                        ...
                        new
                        {
                            ...
                            DateCreate = new DateTime(2024, 10, 9, 17, 26, 57, 365, DateTimeKind.Local).AddTicks(5242),
                        ...
                        new
                        {
                            ...
                            BlogCategoryId = 1,
                            Content = " 🌈 Để phục vụ nhu cầu tư vấn, đăng ký nhập học của các bạn học sinh, bắt đầu từ tuần này Văn phòng tuyển sinh của Trường Cao đẳng FPT Polytechnic Hà Nội sẽ làm việc tất cả các ngày trong tuần (từ thứ 2 đến thứ bảy).\r\n🕰️ Thời gian: \r\nSáng: 8h -12h\r\nChiều: 13h30- 17h30\r\n✅ Các bạn học sinh và phụ huynh lưu ý, khi đến trường thì vào CỔNG SỐ 1 - chỗ cây ATM TP Bank màu tím và đi vào Văn phòng tuyển sinh từ lớp 12 trở lên để làm thủ tục nhập học.\r\n👉 Còn đợi gì nữa, xách balo lên trường nộp hồ sơ và tham quan ngay nào!",
                            DateCreate = new DateTime(2024, 10, 9, 17, 26, 57, 365, DateTimeKind.Local).AddTicks(5243),
                            Description = " Để phục vụ nhu cầu tư vấn, đăng ký nhập học của các bạn học sinh, bắt đầu từ tuần này Văn phòng tuyển sinh của Trường Cao đẳng FPT Polytechnic Hà Nội sẽ làm việc tất cả các ngày trong tuần (từ thứ 2 đến thứ bảy).",
                            Title = "🔈 THÔNG BÁO: VĂN PHÒNG TUYỂN SINH CỦA FPT POLYTECHNIC HÀ NỘI SẼ LÀM VIỆC CẢ TUẦN 🔈"
                        },
                        new
                        {
                            ...
                            BlogCategoryId = 1,
                            Content = " 🌈 Để phục vụ nhu cầu tư vấn, đăng ký nhập học của các bạn học sinh, bắt đầu từ tuần này Văn phòng tuyển sinh của Trường Cao đẳng FPT Polytechnic Hà Nội sẽ làm việc tất cả các ngày trong tuần (từ thứ 2 đến thứ bảy).\r\n🕰️ Thời gian: \r\nSáng: 8h -12h\r\nChiều: 13h30- 17h30\r\n✅ Các bạn học sinh và phụ huynh lưu ý, khi đến trường thì vào CỔNG SỐ 1 - chỗ cây ATM TP Bank màu tím và đi vào Văn phòng tuyển sinh từ lớp 12 trở lên để làm thủ tục nhập học.\r\n👉 Còn đợi gì nữa, xách balo lên trường nộp hồ sơ và tham quan ngay nào!",
                            DateCreate = new DateTime(2024, 10, 9, 17, 26, 57, 365, DateTimeKind.Local).AddTicks(5244),
                            Description = " Để phục vụ nhu cầu tư vấn, đăng ký nhập học của các bạn học sinh, bắt đầu từ tuần này Văn phòng tuyển sinh của Trường Cao đẳng FPT Polytechnic Hà Nội sẽ làm việc tất cả các ngày trong tuần (từ thứ 2 đến thứ bảy).",
                            Title = "🔈 THÔNG BÁO: VĂN PHÒNG TUYỂN SINH CỦA FPT POLYTECHNIC HÀ NỘI SẼ LÀM VIỆC CẢ TUẦN 🔈"
                        },
                        new
                        ...
                        new
                        {
                            ...
                            BlogCategoryId = 1,
                            Content = " 🌈 Để phục vụ nhu cầu tư vấn, đăng ký nhập học của các bạn học sinh, bắt đầu từ tuần này Văn phòng tuyển sinh của Trường Cao đẳng FPT Polytechnic Hà Nội sẽ làm việc tất cả các ngày trong tuần (từ thứ 2 đến thứ bảy).\r\n🕰️ Thời gian: \r\nSáng: 8h -12h\r\nChiều: 13h30- 17h30\r\n✅ Các bạn học sinh và phụ huynh lưu ý, khi đến trường thì vào CỔNG SỐ 1 - chỗ cây ATM TP Bank màu tím và đi vào Văn phòng tuyển sinh từ lớp 12 trở lên để làm thủ tục nhập học.\r\n👉 Còn đợi gì nữa, xách balo lên trường nộp hồ sơ và tham quan ngay nào!",
                            DateCreate = new DateTime(2024, 10, 9, 17, 26, 57, 365, DateTimeKind.Local).AddTicks(5245),
                            Description = " Để phục vụ nhu cầu tư vấn, đăng ký nhập học của các bạn học sinh, bắt đầu từ tuần này Văn phòng tuyển sinh của Trường Cao đẳng FPT Polytechnic Hà Nội sẽ làm việc tất cả các ngày trong tuần (từ thứ 2 đến thứ bảy).",
                            Title = "🔈 THÔNG BÁO: VĂN PHÒNG TUYỂN SINH CỦA FPT POLYTECHNIC HÀ NỘI SẼ LÀM VIỆC CẢ TUẦN 🔈"
                        });
                });
            ...
            modelBuilder.Entity("Data.Models.StudentConsultation", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            StudentConsultationId = new Guid("c83d90da-3dc5-4198-9e5d-22facce04406"),
                            CampusId = "Hanoi",
                        ...
                        new
                        {
                            StudentConsultationId = new Guid("4c9132f2-1882-4a93-ac91-c02b17248867"),
                            CampusId = "Hanoi",
                            DateReceive = new DateTime(2024, 9, 18, 14, 30, 0, 0, DateTimeKind.Unspecified),
                            Email = "nguyenducanh01.57@gmail.com",
                            FullName = "Nguyen Đức Anh",
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRole<System.Guid>", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ConcurrencyStamp = "2bad64a4-d2ca-415b-ab2c-b7fc35c12018",
                            Name = "Admin",
                        ...
                        new
                        {
                            ...
                            ConcurrencyStamp = "b20c64e4-e56a-4b2c-8c85-4c8462390456",
                            Name = "Student",
