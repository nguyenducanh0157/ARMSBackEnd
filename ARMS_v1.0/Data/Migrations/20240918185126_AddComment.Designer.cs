...
namespace Data.Migrations
{
    ...
    [Migration("20240918185126_AddComment")]
            ...
            modelBuilder.Entity("Data.Models.Account", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            CampusId = "Hanoi",
                            ConcurrencyStamp = "bd2c0e9b-e2c5-493a-bff6-754a6a2f8ae1",
                            ...
                            PasswordHash = "AQAAAAEAACcQAAAAEJUQ+1sEuCmWXJr0VkH9vvak8qdJUTV2oXZR0OGOQk3Kw7AvVJjcn8B/23j9fH5VKg==",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "8341cd8e-4c65-4527-9056-aea55f5e7371",
            ...
            modelBuilder.Entity("Data.Models.Blog", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            BlogId = 1,
                            BlogCategoryId = 3,
                            DateCreate = new DateTime(2024, 9, 19, 1, 51, 25, 12, DateTimeKind.Local).AddTicks(3219),
                        ...
                        new
                        {
                            BlogId = 2,
                            BlogCategoryId = 3,
                            DateCreate = new DateTime(2024, 9, 19, 1, 51, 25, 12, DateTimeKind.Local).AddTicks(3232),
                        ...
                        new
                        {
                            BlogId = 3,
                            BlogCategoryId = 2,
                            DateCreate = new DateTime(2024, 9, 19, 1, 51, 25, 12, DateTimeKind.Local).AddTicks(3234),
                        ...
                        new
                        {
                            BlogId = 4,
                            BlogCategoryId = 1,
                            DateCreate = new DateTime(2024, 9, 19, 1, 51, 25, 12, DateTimeKind.Local).AddTicks(3236),
                        ...
                        new
                        {
                            BlogId = 5,
                            BlogCategoryId = 1,
                            DateCreate = new DateTime(2024, 9, 19, 1, 51, 25, 12, DateTimeKind.Local).AddTicks(3237),
                            Description = " Để phục vụ nhu cầu tư vấn, đăng ký nhập học của các bạn học sinh, bắt đầu từ tuần này Văn phòng tuyển sinh của Trường Cao đẳng FPT Polytechnic Hà Nội sẽ làm việc tất cả các ngày trong tuần (từ thứ 2 đến thứ bảy).",
                            Title = "🔈 THÔNG BÁO: VĂN PHÒNG TUYỂN SINH CỦA FPT POLYTECHNIC HÀ NỘI SẼ LÀM VIỆC CẢ TUẦN 🔈"
                        },
                        new
                        {
                            BlogId = 6,
                            BlogCategoryId = 1,
                            DateCreate = new DateTime(2024, 9, 19, 1, 51, 25, 12, DateTimeKind.Local).AddTicks(3238),
                            Description = " Để phục vụ nhu cầu tư vấn, đăng ký nhập học của các bạn học sinh, bắt đầu từ tuần này Văn phòng tuyển sinh của Trường Cao đẳng FPT Polytechnic Hà Nội sẽ làm việc tất cả các ngày trong tuần (từ thứ 2 đến thứ bảy).",
                            Title = "🔈 THÔNG BÁO: VĂN PHÒNG TUYỂN SINH CỦA FPT POLYTECHNIC HÀ NỘI SẼ LÀM VIỆC CẢ TUẦN 🔈"
                        },
                        new
                        {
                            BlogId = 7,
                            BlogCategoryId = 1,
                            DateCreate = new DateTime(2024, 9, 19, 1, 51, 25, 12, DateTimeKind.Local).AddTicks(3240),
                            Description = " Để phục vụ nhu cầu tư vấn, đăng ký nhập học của các bạn học sinh, bắt đầu từ tuần này Văn phòng tuyển sinh của Trường Cao đẳng FPT Polytechnic Hà Nội sẽ làm việc tất cả các ngày trong tuần (từ thứ 2 đến thứ bảy).",
                            Title = "🔈 THÔNG BÁO: VĂN PHÒNG TUYỂN SINH CỦA FPT POLYTECHNIC HÀ NỘI SẼ LÀM VIỆC CẢ TUẦN 🔈"
                        },
                        new
                        {
                            BlogId = 8,
                            BlogCategoryId = 1,
                            DateCreate = new DateTime(2024, 9, 19, 1, 51, 25, 12, DateTimeKind.Local).AddTicks(3241),
                            Description = " Để phục vụ nhu cầu tư vấn, đăng ký nhập học của các bạn học sinh, bắt đầu từ tuần này Văn phòng tuyển sinh của Trường Cao đẳng FPT Polytechnic Hà Nội sẽ làm việc tất cả các ngày trong tuần (từ thứ 2 đến thứ bảy).",
                            Title = "🔈 THÔNG BÁO: VĂN PHÒNG TUYỂN SINH CỦA FPT POLYTECHNIC HÀ NỘI SẼ LÀM VIỆC CẢ TUẦN 🔈"
                        },
                        new
                        {
                            BlogId = 9,
                            BlogCategoryId = 1,
                            DateCreate = new DateTime(2024, 9, 19, 1, 51, 25, 12, DateTimeKind.Local).AddTicks(3243),
                            Description = " Để phục vụ nhu cầu tư vấn, đăng ký nhập học của các bạn học sinh, bắt đầu từ tuần này Văn phòng tuyển sinh của Trường Cao đẳng FPT Polytechnic Hà Nội sẽ làm việc tất cả các ngày trong tuần (từ thứ 2 đến thứ bảy).",
                            Title = "🔈 THÔNG BÁO: VĂN PHÒNG TUYỂN SINH CỦA FPT POLYTECHNIC HÀ NỘI SẼ LÀM VIỆC CẢ TUẦN 🔈"
                        });
                });
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRole<System.Guid>", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ConcurrencyStamp = "cf9e1e26-d61b-48d6-b39a-e5a1f7c9fc2c",
                            Name = "Admin",
                        ...
                        new
                        {
                            ...
                            ConcurrencyStamp = "5bfd2da8-5b99-4ab2-ba42-56413e5946aa",
                            Name = "Student",
