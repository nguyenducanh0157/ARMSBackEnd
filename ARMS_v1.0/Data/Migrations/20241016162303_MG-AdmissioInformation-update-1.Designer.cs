...
namespace Data.Migrations
{
    ...
    [Migration("20241016162303_MG-AdmissioInformation-update-1")]
    partial class MGAdmissioInformationupdate1
    {
            ...
            modelBuilder.Entity("Data.Models.Account", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            CampusId = "Hanoi",
                            ConcurrencyStamp = "c4cfb333-7cdd-4af7-9c31-88b488a836d4",
                            ...
                            PasswordHash = "AQAAAAEAACcQAAAAEE8mk4a8Amp5kwIwJnqe+zNNnja1WTiSha9fG/KXFq96Z21AtsheHmWCzSogrnVRuA==",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "559fb5f5-379e-47fc-ad9b-68361ba0a496",
                        ...
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            CampusId = "Hanoi",
                            ConcurrencyStamp = "801ff1d0-44c7-44bb-a4d5-a342a9bafbc4",
                            ...
                            PasswordHash = "AQAAAAEAACcQAAAAEA6cTEfX7cAxxXGq+4JonyY+9EhY8PTHbx3eYYrxuaaeLHt8HpXlHs8aU7DSSsoS1w==",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "a15fe2eb-b344-41dc-9042-76590f613e72",
                            TwoFactorEnabled = false,
                        ...
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            CampusId = "Hanoi",
                            ConcurrencyStamp = "8c494698-08b2-444e-bc28-f61700c616ed",
                            ...
                            PasswordHash = "AQAAAAEAACcQAAAAEPNctqxPeQSPDDCelBxQEwqkrVi1UKhTUtTMyh73mDjJyrPUGlafiyjjbEWnn1OAOQ==",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "75c6fdb1-7e1e-40f5-b291-f4d3e886c42a",
                            TwoFactorEnabled = false,
                        ...
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            CampusId = "Hanoi",
                            ConcurrencyStamp = "cd3204f8-c82f-47d4-864a-b9ecc830ed02",
                            ...
                            PasswordHash = "AQAAAAEAACcQAAAAEBta2iUwmDVgSAeJJLgvCs685aRWnLlUKaFNnL0F+esPwqjBCuTPjSlLB1ib9wtP5Q==",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "65a2acab-531a-476d-bf52-f15cb7bc3961",
                            TwoFactorEnabled = false,
            ...
            modelBuilder.Entity("Data.Models.Blog", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            DateCreate = new DateTime(2024, 10, 16, 23, 23, 2, 471, DateTimeKind.Local).AddTicks(5187),
                        ...
                        new
                        {
                            ...
                            DateCreate = new DateTime(2024, 10, 16, 23, 23, 2, 471, DateTimeKind.Local).AddTicks(5199),
                        ...
                        new
                        {
                            ...
                            DateCreate = new DateTime(2024, 10, 16, 23, 23, 2, 471, DateTimeKind.Local).AddTicks(5200),
                        ...
                        new
                        {
                            ...
                            DateCreate = new DateTime(2024, 10, 16, 23, 23, 2, 471, DateTimeKind.Local).AddTicks(5201),
                        ...
                        new
                        {
                            ...
                            BlogCategoryId = 1,
                            Content = " 🌈 Để phục vụ nhu cầu tư vấn, đăng ký nhập học của các bạn học sinh, bắt đầu từ tuần này Văn phòng tuyển sinh của Trường Cao đẳng FPT Polytechnic Hà Nội sẽ làm việc tất cả các ngày trong tuần (từ thứ 2 đến thứ bảy).\r\n🕰️ Thời gian: \r\nSáng: 8h -12h\r\nChiều: 13h30- 17h30\r\n✅ Các bạn học sinh và phụ huynh lưu ý, khi đến trường thì vào CỔNG SỐ 1 - chỗ cây ATM TP Bank màu tím và đi vào Văn phòng tuyển sinh từ lớp 12 trở lên để làm thủ tục nhập học.\r\n👉 Còn đợi gì nữa, xách balo lên trường nộp hồ sơ và tham quan ngay nào!",
                            DateCreate = new DateTime(2024, 10, 16, 23, 23, 2, 471, DateTimeKind.Local).AddTicks(5202),
                            Description = " Để phục vụ nhu cầu tư vấn, đăng ký nhập học của các bạn học sinh, bắt đầu từ tuần này Văn phòng tuyển sinh của Trường Cao đẳng FPT Polytechnic Hà Nội sẽ làm việc tất cả các ngày trong tuần (từ thứ 2 đến thứ bảy).",
                            Title = "🔈 THÔNG BÁO: VĂN PHÒNG TUYỂN SINH CỦA FPT POLYTECHNIC HÀ NỘI SẼ LÀM VIỆC CẢ TUẦN 🔈"
                        },
                        new
                        ...
                        new
                        {
                            ...
                            BlogCategoryId = 1,
                            Content = " 🌈 Để phục vụ nhu cầu tư vấn, đăng ký nhập học của các bạn học sinh, bắt đầu từ tuần này Văn phòng tuyển sinh của Trường Cao đẳng FPT Polytechnic Hà Nội sẽ làm việc tất cả các ngày trong tuần (từ thứ 2 đến thứ bảy).\r\n🕰️ Thời gian: \r\nSáng: 8h -12h\r\nChiều: 13h30- 17h30\r\n✅ Các bạn học sinh và phụ huynh lưu ý, khi đến trường thì vào CỔNG SỐ 1 - chỗ cây ATM TP Bank màu tím và đi vào Văn phòng tuyển sinh từ lớp 12 trở lên để làm thủ tục nhập học.\r\n👉 Còn đợi gì nữa, xách balo lên trường nộp hồ sơ và tham quan ngay nào!",
                            DateCreate = new DateTime(2024, 10, 16, 23, 23, 2, 471, DateTimeKind.Local).AddTicks(5203),
                            Description = " Để phục vụ nhu cầu tư vấn, đăng ký nhập học của các bạn học sinh, bắt đầu từ tuần này Văn phòng tuyển sinh của Trường Cao đẳng FPT Polytechnic Hà Nội sẽ làm việc tất cả các ngày trong tuần (từ thứ 2 đến thứ bảy).",
                            Title = "🔈 THÔNG BÁO: VĂN PHÒNG TUYỂN SINH CỦA FPT POLYTECHNIC HÀ NỘI SẼ LÀM VIỆC CẢ TUẦN 🔈"
                        },
                        new
                        {
                            ...
                            BlogCategoryId = 1,
                            Content = " 🌈 Để phục vụ nhu cầu tư vấn, đăng ký nhập học của các bạn học sinh, bắt đầu từ tuần này Văn phòng tuyển sinh của Trường Cao đẳng FPT Polytechnic Hà Nội sẽ làm việc tất cả các ngày trong tuần (từ thứ 2 đến thứ bảy).\r\n🕰️ Thời gian: \r\nSáng: 8h -12h\r\nChiều: 13h30- 17h30\r\n✅ Các bạn học sinh và phụ huynh lưu ý, khi đến trường thì vào CỔNG SỐ 1 - chỗ cây ATM TP Bank màu tím và đi vào Văn phòng tuyển sinh từ lớp 12 trở lên để làm thủ tục nhập học.\r\n👉 Còn đợi gì nữa, xách balo lên trường nộp hồ sơ và tham quan ngay nào!",
                            DateCreate = new DateTime(2024, 10, 16, 23, 23, 2, 471, DateTimeKind.Local).AddTicks(5204),
                            Description = " Để phục vụ nhu cầu tư vấn, đăng ký nhập học của các bạn học sinh, bắt đầu từ tuần này Văn phòng tuyển sinh của Trường Cao đẳng FPT Polytechnic Hà Nội sẽ làm việc tất cả các ngày trong tuần (từ thứ 2 đến thứ bảy).",
                            Title = "🔈 THÔNG BÁO: VĂN PHÒNG TUYỂN SINH CỦA FPT POLYTECHNIC HÀ NỘI SẼ LÀM VIỆC CẢ TUẦN 🔈"
                        },
                        new
            ...
            modelBuilder.Entity("Data.Models.StudentConsultation", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            StudentConsultationId = new Guid("776ec075-d622-4891-8b92-e035da0b7562"),
                            CampusId = "Hanoi",
                        ...
                        new
                        {
                            StudentConsultationId = new Guid("c9da5df0-b5fd-49d1-995c-1ae64e26383f"),
                            CampusId = "Hanoi",
                            DateReceive = new DateTime(2024, 9, 18, 14, 30, 0, 0, DateTimeKind.Unspecified),
                            Email = "nguyenducanh01.57@gmail.com",
                            FullName = "Nguyen Đức Anh",
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRole<System.Guid>", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ConcurrencyStamp = "08194ac3-8b7f-4d6b-af92-c11592ac2221",
                            Name = "Admin",
                        ...
                        new
                        {
                            ...
                            ConcurrencyStamp = "7565df0c-8c8f-4244-90d4-831e79a24aa1",
                            Name = "Student",
                        ...
                        new
                        {
                            ...
                            ConcurrencyStamp = "6c47675f-3e52-45d7-89f2-9c2be8c08186",
                        ...
                        new
                        {
                            ...
                            ConcurrencyStamp = "6a8513e4-9d58-4fde-8edd-307a10279ece",
                            Name = "SchoolService",
                        ...
                        new
                        {
                            ...
                            ConcurrencyStamp = "391fb793-9d5b-4a66-be8b-fcbc2d72ad03",
