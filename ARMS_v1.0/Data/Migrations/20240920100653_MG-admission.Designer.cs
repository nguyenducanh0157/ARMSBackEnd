...
namespace Data.Migrations
{
    ...
    [Migration("20240920100653_MG-admission")]
    partial class MGadmission
    {
            ...
            modelBuilder.Entity("Data.Models.Account", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            CampusId = "Hanoi",
                            ConcurrencyStamp = "b8fc643b-4f8c-4aa1-8014-5b9f3ccee423",
                            ...
                            PasswordHash = "AQAAAAEAACcQAAAAEBpo8U7G+BrENq4Md06HteiotywD8cO+XiltDQkYQr1GvMrgHRvg6E1pYs+PSOVGZw==",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "46c81469-362a-4363-b156-6c76c7c99b77",
            ...
            modelBuilder.Entity("Data.Models.Blog", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            BlogId = 1,
                            BlogCategoryId = 3,
                            DateCreate = new DateTime(2024, 9, 20, 17, 6, 52, 432, DateTimeKind.Local).AddTicks(9118),
                        ...
                        new
                        {
                            BlogId = 2,
                            BlogCategoryId = 3,
                            DateCreate = new DateTime(2024, 9, 20, 17, 6, 52, 432, DateTimeKind.Local).AddTicks(9127),
                        ...
                        new
                        {
                            BlogId = 3,
                            BlogCategoryId = 2,
                            DateCreate = new DateTime(2024, 9, 20, 17, 6, 52, 432, DateTimeKind.Local).AddTicks(9128),
                        ...
                        new
                        {
                            BlogId = 5,
                            BlogCategoryId = 1,
                            DateCreate = new DateTime(2024, 9, 20, 17, 6, 52, 432, DateTimeKind.Local).AddTicks(9129),
                            Description = " Để phục vụ nhu cầu tư vấn, đăng ký nhập học của các bạn học sinh, bắt đầu từ tuần này Văn phòng tuyển sinh của Trường Cao đẳng FPT Polytechnic Hà Nội sẽ làm việc tất cả các ngày trong tuần (từ thứ 2 đến thứ bảy).",
                            Title = "🔈 THÔNG BÁO: VĂN PHÒNG TUYỂN SINH CỦA FPT POLYTECHNIC HÀ NỘI SẼ LÀM VIỆC CẢ TUẦN 🔈"
                        },
                        new
                        ...
                        new
                        {
                            BlogId = 7,
                            BlogCategoryId = 1,
                            DateCreate = new DateTime(2024, 9, 20, 17, 6, 52, 432, DateTimeKind.Local).AddTicks(9130),
                            Description = " Để phục vụ nhu cầu tư vấn, đăng ký nhập học của các bạn học sinh, bắt đầu từ tuần này Văn phòng tuyển sinh của Trường Cao đẳng FPT Polytechnic Hà Nội sẽ làm việc tất cả các ngày trong tuần (từ thứ 2 đến thứ bảy).",
                            Title = "🔈 THÔNG BÁO: VĂN PHÒNG TUYỂN SINH CỦA FPT POLYTECHNIC HÀ NỘI SẼ LÀM VIỆC CẢ TUẦN 🔈"
                        },
                        new
                        {
                            BlogId = 8,
                            BlogCategoryId = 1,
                            DateCreate = new DateTime(2024, 9, 20, 17, 6, 52, 432, DateTimeKind.Local).AddTicks(9131),
                            Description = " Để phục vụ nhu cầu tư vấn, đăng ký nhập học của các bạn học sinh, bắt đầu từ tuần này Văn phòng tuyển sinh của Trường Cao đẳng FPT Polytechnic Hà Nội sẽ làm việc tất cả các ngày trong tuần (từ thứ 2 đến thứ bảy).",
                            Title = "🔈 THÔNG BÁO: VĂN PHÒNG TUYỂN SINH CỦA FPT POLYTECHNIC HÀ NỘI SẼ LÀM VIỆC CẢ TUẦN 🔈"
                        },
                        new
            ...
            modelBuilder.Entity("Data.Models.Comment", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2024, 9, 20, 17, 6, 52, 432, DateTimeKind.Local).AddTicks(9160),
                        ...
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2024, 9, 20, 17, 6, 52, 432, DateTimeKind.Local).AddTicks(9162),
                        ...
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2024, 9, 20, 17, 6, 52, 432, DateTimeKind.Local).AddTicks(9164),
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRole<System.Guid>", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ConcurrencyStamp = "3226794d-6ffd-43f9-9ffc-65cb63d5c0ce",
                            Name = "Admin",
                        ...
                        new
                        {
                            ...
                            ConcurrencyStamp = "ed067301-08a6-4e2e-b0ea-b22eb25268d6",
                            Name = "Student",
