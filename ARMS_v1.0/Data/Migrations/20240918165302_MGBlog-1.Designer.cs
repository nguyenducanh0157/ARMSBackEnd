...
namespace Data.Migrations
{
    ...
    [Migration("20240918165302_MGBlog-1")]
    partial class MGBlog1
    {
            ...
            modelBuilder.Entity("Data.Models.Account", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            CampusId = "Hanoi",
                            ConcurrencyStamp = "bd1dca9e-864d-4e05-92d6-66576662cdd3",
                            ...
                            PasswordHash = "AQAAAAEAACcQAAAAEK7bR3o0p+K/OQBjUi69uuCZsj9nkhz3ra0J5CZ/mkvgX7k+AJCJLD1wTs/Yn3hKJw==",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "960da8bf-47ba-4c30-a062-f2a3f62b28ba",
            ...
            modelBuilder.Entity("Data.Models.Blog", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            BlogId = 1,
                            BlogCategoryId = 3,
                            DateCreate = new DateTime(2024, 9, 18, 23, 53, 1, 282, DateTimeKind.Local).AddTicks(5915),
                        ...
                        new
                        {
                            BlogId = 2,
                            BlogCategoryId = 3,
                            DateCreate = new DateTime(2024, 9, 18, 23, 53, 1, 282, DateTimeKind.Local).AddTicks(5931),
                        ...
                        new
                        {
                            BlogId = 3,
                            BlogCategoryId = 2,
                            DateCreate = new DateTime(2024, 9, 18, 23, 53, 1, 282, DateTimeKind.Local).AddTicks(5933),
                        ...
                        new
                        {
                            BlogId = 4,
                            BlogCategoryId = 1,
                            DateCreate = new DateTime(2024, 9, 18, 23, 53, 1, 282, DateTimeKind.Local).AddTicks(5934),
                        ...
                        new
                        {
                            BlogId = 5,
                            BlogCategoryId = 1,
                            DateCreate = new DateTime(2024, 9, 18, 23, 53, 1, 282, DateTimeKind.Local).AddTicks(5935),
                            Description = " Để phục vụ nhu cầu tư vấn, đăng ký nhập học của các bạn học sinh, bắt đầu từ tuần này Văn phòng tuyển sinh của Trường Cao đẳng FPT Polytechnic Hà Nội sẽ làm việc tất cả các ngày trong tuần (từ thứ 2 đến thứ bảy).",
                            Title = "🔈 THÔNG BÁO: VĂN PHÒNG TUYỂN SINH CỦA FPT POLYTECHNIC HÀ NỘI SẼ LÀM VIỆC CẢ TUẦN 🔈"
                        },
                        new
                        ...
                        new
                        {
                            BlogId = 7,
                            BlogCategoryId = 1,
                            DateCreate = new DateTime(2024, 9, 18, 23, 53, 1, 282, DateTimeKind.Local).AddTicks(5936),
                            Description = " Để phục vụ nhu cầu tư vấn, đăng ký nhập học của các bạn học sinh, bắt đầu từ tuần này Văn phòng tuyển sinh của Trường Cao đẳng FPT Polytechnic Hà Nội sẽ làm việc tất cả các ngày trong tuần (từ thứ 2 đến thứ bảy).",
                            Title = "🔈 THÔNG BÁO: VĂN PHÒNG TUYỂN SINH CỦA FPT POLYTECHNIC HÀ NỘI SẼ LÀM VIỆC CẢ TUẦN 🔈"
                        },
                        new
                        {
                            BlogId = 8,
                            BlogCategoryId = 1,
                            DateCreate = new DateTime(2024, 9, 18, 23, 53, 1, 282, DateTimeKind.Local).AddTicks(5937),
                            Description = " Để phục vụ nhu cầu tư vấn, đăng ký nhập học của các bạn học sinh, bắt đầu từ tuần này Văn phòng tuyển sinh của Trường Cao đẳng FPT Polytechnic Hà Nội sẽ làm việc tất cả các ngày trong tuần (từ thứ 2 đến thứ bảy).",
                            Title = "🔈 THÔNG BÁO: VĂN PHÒNG TUYỂN SINH CỦA FPT POLYTECHNIC HÀ NỘI SẼ LÀM VIỆC CẢ TUẦN 🔈"
                        },
                        new
                        {
                            BlogId = 9,
                            BlogCategoryId = 1,
                            DateCreate = new DateTime(2024, 9, 18, 23, 53, 1, 282, DateTimeKind.Local).AddTicks(5938),
                            Description = " Để phục vụ nhu cầu tư vấn, đăng ký nhập học của các bạn học sinh, bắt đầu từ tuần này Văn phòng tuyển sinh của Trường Cao đẳng FPT Polytechnic Hà Nội sẽ làm việc tất cả các ngày trong tuần (từ thứ 2 đến thứ bảy).",
                            Title = "🔈 THÔNG BÁO: VĂN PHÒNG TUYỂN SINH CỦA FPT POLYTECHNIC HÀ NỘI SẼ LÀM VIỆC CẢ TUẦN 🔈"
                        });
                });
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRole<System.Guid>", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ConcurrencyStamp = "257fc2c3-74ad-42b2-a863-d6aed72b48fc",
                            Name = "Admin",
                        ...
                        new
                        {
                            ...
                            ConcurrencyStamp = "b99f7a34-f24d-4ccf-9b21-599f1dd21d8c",
                            Name = "Student",
