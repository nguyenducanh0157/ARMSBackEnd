...
namespace Data.Migrations
{
    ...
    [Migration("20241009111056_MG-TypeAdmission-update-2")]
    partial class MGTypeAdmissionupdate2
    {
            ...
            modelBuilder.Entity("Data.Models.Account", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            CampusId = "Hanoi",
                            ConcurrencyStamp = "b2ddbb62-9352-420b-ba71-bd8095e06a6b",
                            ...
                            PasswordHash = "AQAAAAEAACcQAAAAEM7oMgs+yOsZkTM/cJvMA2pm4wGCIytz0nkIGqV3it0U6038QAFniVHSdRtS4u8h+w==",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "639d360c-4f6f-4983-82e3-caf8c4c89e95",
            ...
            modelBuilder.Entity("Data.Models.Blog", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            DateCreate = new DateTime(2024, 10, 9, 18, 10, 55, 363, DateTimeKind.Local).AddTicks(9784),
                        ...
                        new
                        {
                            ...
                            DateCreate = new DateTime(2024, 10, 9, 18, 10, 55, 363, DateTimeKind.Local).AddTicks(9792),
                        ...
                        new
                        {
                            ...
                            DateCreate = new DateTime(2024, 10, 9, 18, 10, 55, 363, DateTimeKind.Local).AddTicks(9793),
                        ...
                        new
                        {
                            ...
                            DateCreate = new DateTime(2024, 10, 9, 18, 10, 55, 363, DateTimeKind.Local).AddTicks(9794),
                        ...
                        new
                        {
                            ...
                            BlogCategoryId = 1,
                            Content = " 🌈 Để phục vụ nhu cầu tư vấn, đăng ký nhập học của các bạn học sinh, bắt đầu từ tuần này Văn phòng tuyển sinh của Trường Cao đẳng FPT Polytechnic Hà Nội sẽ làm việc tất cả các ngày trong tuần (từ thứ 2 đến thứ bảy).\r\n🕰️ Thời gian: \r\nSáng: 8h -12h\r\nChiều: 13h30- 17h30\r\n✅ Các bạn học sinh và phụ huynh lưu ý, khi đến trường thì vào CỔNG SỐ 1 - chỗ cây ATM TP Bank màu tím và đi vào Văn phòng tuyển sinh từ lớp 12 trở lên để làm thủ tục nhập học.\r\n👉 Còn đợi gì nữa, xách balo lên trường nộp hồ sơ và tham quan ngay nào!",
                            DateCreate = new DateTime(2024, 10, 9, 18, 10, 55, 363, DateTimeKind.Local).AddTicks(9795),
                            Description = " Để phục vụ nhu cầu tư vấn, đăng ký nhập học của các bạn học sinh, bắt đầu từ tuần này Văn phòng tuyển sinh của Trường Cao đẳng FPT Polytechnic Hà Nội sẽ làm việc tất cả các ngày trong tuần (từ thứ 2 đến thứ bảy).",
                            Title = "🔈 THÔNG BÁO: VĂN PHÒNG TUYỂN SINH CỦA FPT POLYTECHNIC HÀ NỘI SẼ LÀM VIỆC CẢ TUẦN 🔈"
                        },
                        new
                        {
                            ...
                            BlogCategoryId = 1,
                            Content = " 🌈 Để phục vụ nhu cầu tư vấn, đăng ký nhập học của các bạn học sinh, bắt đầu từ tuần này Văn phòng tuyển sinh của Trường Cao đẳng FPT Polytechnic Hà Nội sẽ làm việc tất cả các ngày trong tuần (từ thứ 2 đến thứ bảy).\r\n🕰️ Thời gian: \r\nSáng: 8h -12h\r\nChiều: 13h30- 17h30\r\n✅ Các bạn học sinh và phụ huynh lưu ý, khi đến trường thì vào CỔNG SỐ 1 - chỗ cây ATM TP Bank màu tím và đi vào Văn phòng tuyển sinh từ lớp 12 trở lên để làm thủ tục nhập học.\r\n👉 Còn đợi gì nữa, xách balo lên trường nộp hồ sơ và tham quan ngay nào!",
                            DateCreate = new DateTime(2024, 10, 9, 18, 10, 55, 363, DateTimeKind.Local).AddTicks(9796),
                            Description = " Để phục vụ nhu cầu tư vấn, đăng ký nhập học của các bạn học sinh, bắt đầu từ tuần này Văn phòng tuyển sinh của Trường Cao đẳng FPT Polytechnic Hà Nội sẽ làm việc tất cả các ngày trong tuần (từ thứ 2 đến thứ bảy).",
                            Title = "🔈 THÔNG BÁO: VĂN PHÒNG TUYỂN SINH CỦA FPT POLYTECHNIC HÀ NỘI SẼ LÀM VIỆC CẢ TUẦN 🔈"
                        },
                        new
                        {
                            ...
                            BlogCategoryId = 1,
                            Content = " 🌈 Để phục vụ nhu cầu tư vấn, đăng ký nhập học của các bạn học sinh, bắt đầu từ tuần này Văn phòng tuyển sinh của Trường Cao đẳng FPT Polytechnic Hà Nội sẽ làm việc tất cả các ngày trong tuần (từ thứ 2 đến thứ bảy).\r\n🕰️ Thời gian: \r\nSáng: 8h -12h\r\nChiều: 13h30- 17h30\r\n✅ Các bạn học sinh và phụ huynh lưu ý, khi đến trường thì vào CỔNG SỐ 1 - chỗ cây ATM TP Bank màu tím và đi vào Văn phòng tuyển sinh từ lớp 12 trở lên để làm thủ tục nhập học.\r\n👉 Còn đợi gì nữa, xách balo lên trường nộp hồ sơ và tham quan ngay nào!",
                            DateCreate = new DateTime(2024, 10, 9, 18, 10, 55, 363, DateTimeKind.Local).AddTicks(9797),
                            Description = " Để phục vụ nhu cầu tư vấn, đăng ký nhập học của các bạn học sinh, bắt đầu từ tuần này Văn phòng tuyển sinh của Trường Cao đẳng FPT Polytechnic Hà Nội sẽ làm việc tất cả các ngày trong tuần (từ thứ 2 đến thứ bảy).",
                            Title = "🔈 THÔNG BÁO: VĂN PHÒNG TUYỂN SINH CỦA FPT POLYTECHNIC HÀ NỘI SẼ LÀM VIỆC CẢ TUẦN 🔈"
                        },
                        new
            ...
            modelBuilder.Entity("Data.Models.StudentConsultation", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            StudentConsultationId = new Guid("4818dad9-7e11-424c-961f-0d5c3799eab7"),
                            CampusId = "Hanoi",
                        ...
                        new
                        {
                            StudentConsultationId = new Guid("6f899dfb-26f8-4395-965c-56f03f772bd3"),
                            CampusId = "Hanoi",
                            DateReceive = new DateTime(2024, 9, 18, 14, 30, 0, 0, DateTimeKind.Unspecified),
                            Email = "nguyenducanh01.57@gmail.com",
                            FullName = "Nguyen Đức Anh",
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRole<System.Guid>", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ConcurrencyStamp = "3a619d50-c8f1-4794-a647-91323723f0fb",
                            Name = "Admin",
                        ...
                        new
                        {
                            ...
                            ConcurrencyStamp = "00e31af9-c9e5-4745-912c-4f7b762c20ce",
                            Name = "Student",
