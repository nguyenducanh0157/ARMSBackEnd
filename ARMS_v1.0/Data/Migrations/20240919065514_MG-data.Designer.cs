...
namespace Data.Migrations
{
    ...
    [Migration("20240919065514_MG-data")]
    partial class MGdata
    {
            ...
            modelBuilder.Entity("Data.Models.Account", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            CampusId = "Hanoi",
                            ConcurrencyStamp = "2b8802c3-bba6-4b14-9eec-8c4626e5a60f",
                            ...
                            PasswordHash = "AQAAAAEAACcQAAAAEDZWepffONJFU4w/qklMncKkl6NV7EEroNmK+R6cqlWeo2uH9HjiPQpkJb7ajZpQgw==",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "e72f1495-a4d8-4e65-8f6d-50892ebb433b",
            ...
            modelBuilder.Entity("Data.Models.Blog", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            BlogId = 1,
                            BlogCategoryId = 3,
                            DateCreate = new DateTime(2024, 9, 19, 13, 55, 13, 409, DateTimeKind.Local).AddTicks(4348),
                        ...
                        new
                        {
                            BlogId = 2,
                            BlogCategoryId = 3,
                            DateCreate = new DateTime(2024, 9, 19, 13, 55, 13, 409, DateTimeKind.Local).AddTicks(4359),
                        ...
                        new
                        {
                            BlogId = 3,
                            BlogCategoryId = 2,
                            DateCreate = new DateTime(2024, 9, 19, 13, 55, 13, 409, DateTimeKind.Local).AddTicks(4360),
                        ...
                        new
                        {
                            BlogId = 4,
                            BlogCategoryId = 1,
                            DateCreate = new DateTime(2024, 9, 19, 13, 55, 13, 409, DateTimeKind.Local).AddTicks(4361),
                        ...
                        new
                        {
                            BlogId = 5,
                            BlogCategoryId = 1,
                            DateCreate = new DateTime(2024, 9, 19, 13, 55, 13, 409, DateTimeKind.Local).AddTicks(4362),
                            Description = " Để phục vụ nhu cầu tư vấn, đăng ký nhập học của các bạn học sinh, bắt đầu từ tuần này Văn phòng tuyển sinh của Trường Cao đẳng FPT Polytechnic Hà Nội sẽ làm việc tất cả các ngày trong tuần (từ thứ 2 đến thứ bảy).",
                            Title = "🔈 THÔNG BÁO: VĂN PHÒNG TUYỂN SINH CỦA FPT POLYTECHNIC HÀ NỘI SẼ LÀM VIỆC CẢ TUẦN 🔈"
                        },
                        new
                        {
                            BlogId = 6,
                            BlogCategoryId = 1,
                            DateCreate = new DateTime(2024, 9, 19, 13, 55, 13, 409, DateTimeKind.Local).AddTicks(4363),
                            Description = " Để phục vụ nhu cầu tư vấn, đăng ký nhập học của các bạn học sinh, bắt đầu từ tuần này Văn phòng tuyển sinh của Trường Cao đẳng FPT Polytechnic Hà Nội sẽ làm việc tất cả các ngày trong tuần (từ thứ 2 đến thứ bảy).",
                            Title = "🔈 THÔNG BÁO: VĂN PHÒNG TUYỂN SINH CỦA FPT POLYTECHNIC HÀ NỘI SẼ LÀM VIỆC CẢ TUẦN 🔈"
                        },
                        new
                        ...
                        new
                        {
                            BlogId = 8,
                            BlogCategoryId = 1,
                            DateCreate = new DateTime(2024, 9, 19, 13, 55, 13, 409, DateTimeKind.Local).AddTicks(4364),
                            Description = " Để phục vụ nhu cầu tư vấn, đăng ký nhập học của các bạn học sinh, bắt đầu từ tuần này Văn phòng tuyển sinh của Trường Cao đẳng FPT Polytechnic Hà Nội sẽ làm việc tất cả các ngày trong tuần (từ thứ 2 đến thứ bảy).",
                            Title = "🔈 THÔNG BÁO: VĂN PHÒNG TUYỂN SINH CỦA FPT POLYTECHNIC HÀ NỘI SẼ LÀM VIỆC CẢ TUẦN 🔈"
                        },
                        new
                        {
                            BlogId = 9,
                            BlogCategoryId = 1,
                            DateCreate = new DateTime(2024, 9, 19, 13, 55, 13, 409, DateTimeKind.Local).AddTicks(4365),
                            Description = " Để phục vụ nhu cầu tư vấn, đăng ký nhập học của các bạn học sinh, bắt đầu từ tuần này Văn phòng tuyển sinh của Trường Cao đẳng FPT Polytechnic Hà Nội sẽ làm việc tất cả các ngày trong tuần (từ thứ 2 đến thứ bảy).",
                            Title = "🔈 THÔNG BÁO: VĂN PHÒNG TUYỂN SINH CỦA FPT POLYTECHNIC HÀ NỘI SẼ LÀM VIỆC CẢ TUẦN 🔈"
                        });
                });
            ...
            modelBuilder.Entity("Data.Models.Comment", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2024, 9, 19, 13, 55, 13, 409, DateTimeKind.Local).AddTicks(4400),
                        ...
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2024, 9, 19, 13, 55, 13, 409, DateTimeKind.Local).AddTicks(4406),
                        ...
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2024, 9, 19, 13, 55, 13, 409, DateTimeKind.Local).AddTicks(4408),
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRole<System.Guid>", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ConcurrencyStamp = "d2d75bf0-8ead-4e14-90d0-2f1fdb41cf49",
                            Name = "Admin",
                        ...
                        new
                        {
                            ...
                            ConcurrencyStamp = "98f8a8ff-0962-4ca8-bbe1-6a94c7fad0a1",
                            Name = "Student",
