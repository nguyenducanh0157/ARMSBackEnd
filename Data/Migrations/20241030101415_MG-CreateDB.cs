    ...
    public partial class MGCreateDB : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("602f7a5f-e0a7-4c00-9da0-a413bfcfab3a"), "f5e618cb-f9e2-4e78-8fbe-4b972a935692", "SchoolService", "SCHOOLSERVICE" },
                    { new Guid("62378687-e16c-4d94-b767-de9f0bfe9498"), "b8ab4db4-99d3-49cc-b5e2-d654dd5e5a4c", "AdmissionOfficer", "ADMISSIONOFFICER" },
                    { new Guid("b8fd818f-63f1-49ee-bec5-f7b66cafbfca"), "03590bc2-9636-4198-aac5-e3dd3449f597", "Admin", "ADMIN" },
                    { new Guid("d2d63c5b-d09b-4828-8322-f18ba103fe86"), "02aab197-e04b-463c-9b35-27b1df5316dd", "Student", "STUDENT" },
                    { new Guid("e5ec8836-e240-4bfc-9bbe-33f2cc7a404d"), "fbf8e310-fd6b-4d24-b388-dff6289653be", "AdmissionCouncil", "ADMISSIONCOUNCIL" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("17baf918-d5d2-4628-aad1-8a4926520676"), 0, null, "Hanoi", "689aeb56-2b8f-426f-955b-b65eddd0a9f4", null, "SchoolService@gmail.com", true, "School Service Hanoi", null, false, null, "SCHOOLSERVICE@GMAIL.COM", "SCHOOLSERVICE", "AQAAAAEAACcQAAAAEBu6+kymwYZdPmyfle2uHtm5da5PAsbM0XSNqakGSdN7E+meePR9Cz/Mb9RDn/am7Q==", null, null, false, null, "3d58308c-13ac-4136-93e4-098a392d289c", false, "SchoolService", false },
                    { new Guid("2f36ad81-47c3-4194-9af8-ba19300695aa"), 0, null, "Hanoi", "bcf93b58-4287-45c6-93d6-5072f05dcbce", null, "nguyenducanh01.57@gmail.com", true, "Nguyễn Đức Anh", null, false, null, "NGUYENDUCANH01.57@GMAIL.COM", "STUDENT", "AQAAAAEAACcQAAAAEPBhyPByGTkQpwpEZ/kX8jWXV0pHbF8VrRqV5Cp0ubvp/xmWdGbNmnzZIBL8jz1p7Q==", null, null, false, null, "d34e7d34-a848-4e1f-95b5-16a5dbf2f1e3", false, "DucAnh", false },
                    { new Guid("5738248d-b40e-4332-9b9e-deb0abc8f8dd"), 0, null, "Hanoi", "31aae94e-893a-40d5-a522-4e5856520b63", null, "AdmissionOfficer@gmail.com", true, "Admin Officer Hanoi", null, false, null, "ADMISSIONOFFICER@GMAIL.COM", "ADMISSIONOFFICER", "AQAAAAEAACcQAAAAEHxyjqoUQDLeFvzky+XHSVGCam06s5xmtmn35am3VWio3jtv27CG++olHVGxr5sK1Q==", null, null, false, null, "4971ef1b-c580-4927-b287-3c3b6b630787", false, "AdmissionOfficer", false },
                    { new Guid("aa321fa2-d640-449f-9cf3-d5a14001aa3e"), 0, null, "Hanoi", "0165c5f8-b1d9-4a69-bca1-145dcc05008b", null, "AdmissionCouncil@gmail.com", true, "Admission Council Hanoi", null, false, null, "ADMISSIONCOUNCIL@GMAIL.COM", "ADMISSIONCOUNCIL", "AQAAAAEAACcQAAAAEK25IKCKho5bGkIvZ6N1QpywVHO/imcWFOkPC1YQ5SZnzwfdOgGYhbiSmhYFvFSYqg==", null, null, false, null, "7fa65d6c-ad54-4d47-89ae-159635ef87d4", false, "AdmissionCouncil", false },
                    { new Guid("b8c777a9-55b9-4b3d-860a-d7b56e4c24b7"), 0, null, "Hanoi", "90612813-d29b-41b3-96a6-8dc1a51b4930", null, "AdminHaNoi@gmail.com", true, "Admin Hanoi", null, false, null, "ADMINHANOI@GMAIL.COM", "ADMINISTRATOR", "AQAAAAEAACcQAAAAEKwecpNPBeNxyiuBSSOxBMMW8Rh0sVarD8+kW9XhYo9hkMEm1qt1c+UecfzSdXX/FA==", null, null, false, null, "99a817e7-990f-4cee-928d-950bff0a71f9", false, "Administrator", false }
                });
            ...
            migrationBuilder.InsertData(
                ...
                columns: new[] { "SpId", "AccountId", "AddressRecipientResults", "CIAddress", "CIDate", "CampusId", "CitizenIentificationNumber", "District", "Dob", "EmailStudent", "Fullname", "FullnameParents", "Gender", "ImgAcademicTranscript1", "ImgAcademicTranscript2", "ImgAcademicTranscript3", "ImgAcademicTranscript4", "ImgAcademicTranscript5", "ImgCitizenIdentification1", "ImgCitizenIdentification2", "ImgDiploma", "Imgpriority", "Major1", "Major2", "Nation", "PermanentAddress", "PhoneParents", "PhoneStudent", "PriorityDetailPriorityID", "Province", "RecipientResults", "SchoolName", "SpecificAddress", "StudentCode", "TimeRegister", "TypeOfDiploma", "TypeOfTranscript", "TypeofStatus", "Ward", "YearOfGraduation" },
                values: new object[] { new Guid("795b3e70-1312-4889-8352-a696757d1730"), null, null, "HCM", new DateTime(2024, 10, 30, 17, 14, 15, 212, DateTimeKind.Local).AddTicks(1833), "Hanoi", "038301010101", null, new DateTime(2024, 10, 30, 17, 14, 15, 212, DateTimeKind.Local).AddTicks(1834), "hoaithu1707.25@gmail.com", "Truong Thi Thu", null, true, null, null, null, null, null, null, null, null, null, "HAO", null, null, null, null, "0971341554", 1, null, null, null, null, null, new DateTime(2024, 10, 30, 17, 14, 15, 212, DateTimeKind.Local).AddTicks(1835), 5, null, 0, null, null });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 8, 1, " 🌈 Để phục vụ nhu cầu tư vấn, đăng ký nhập học của các bạn học sinh, bắt đầu từ tuần này Văn phòng tuyển sinh của Trường Cao đẳng FPT Polytechnic Hà Nội sẽ làm việc tất cả các ngày trong tuần (từ thứ 2 đến thứ bảy).\r\n🕰️ Thời gian: \r\nSáng: 8h -12h\r\nChiều: 13h30- 17h30\r\n✅ Các bạn học sinh và phụ huynh lưu ý, khi đến trường thì vào CỔNG SỐ 1 - chỗ cây ATM TP Bank màu tím và đi vào Văn phòng tuyển sinh từ lớp 12 trở lên để làm thủ tục nhập học.\r\n👉 Còn đợi gì nữa, xách balo lên trường nộp hồ sơ và tham quan ngay nào!", new DateTime(2024, 10, 30, 17, 14, 15, 212, DateTimeKind.Local).AddTicks(1704), " Để phục vụ nhu cầu tư vấn, đăng ký nhập học của các bạn học sinh, bắt đầu từ tuần này Văn phòng tuyển sinh của Trường Cao đẳng FPT Polytechnic Hà Nội sẽ làm việc tất cả các ngày trong tuần (từ thứ 2 đến thứ bảy).", null, "🔈 THÔNG BÁO: VĂN PHÒNG TUYỂN SINH CỦA FPT POLYTECHNIC HÀ NỘI SẼ LÀM VIỆC CẢ TUẦN 🔈" },
                    { 9, 1, " 🌈 Để phục vụ nhu cầu tư vấn, đăng ký nhập học của các bạn học sinh, bắt đầu từ tuần này Văn phòng tuyển sinh của Trường Cao đẳng FPT Polytechnic Hà Nội sẽ làm việc tất cả các ngày trong tuần (từ thứ 2 đến thứ bảy).\r\n🕰️ Thời gian: \r\nSáng: 8h -12h\r\nChiều: 13h30- 17h30\r\n✅ Các bạn học sinh và phụ huynh lưu ý, khi đến trường thì vào CỔNG SỐ 1 - chỗ cây ATM TP Bank màu tím và đi vào Văn phòng tuyển sinh từ lớp 12 trở lên để làm thủ tục nhập học.\r\n👉 Còn đợi gì nữa, xách balo lên trường nộp hồ sơ và tham quan ngay nào!", new DateTime(2024, 10, 30, 17, 14, 15, 212, DateTimeKind.Local).AddTicks(1705), " Để phục vụ nhu cầu tư vấn, đăng ký nhập học của các bạn học sinh, bắt đầu từ tuần này Văn phòng tuyển sinh của Trường Cao đẳng FPT Polytechnic Hà Nội sẽ làm việc tất cả các ngày trong tuần (từ thứ 2 đến thứ bảy).", null, "🔈 THÔNG BÁO: VĂN PHÒNG TUYỂN SINH CỦA FPT POLYTECHNIC HÀ NỘI SẼ LÀM VIỆC CẢ TUẦN 🔈" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new Guid("2f36ad81-47c3-4194-9af8-ba19300695aa"), "Hanoi", new DateTime(2024, 10, 30, 17, 14, 15, 212, DateTimeKind.Local).AddTicks(1878), "Em muốn chuyển ngành!", "file", "HME", false },
                    { 2, new Guid("2f36ad81-47c3-4194-9af8-ba19300695aa"), "Hanoi", new DateTime(2024, 10, 30, 17, 14, 15, 212, DateTimeKind.Local).AddTicks(1881), "Em muốn chuyển ngành!", "file", "HME", false }
                });
            ...
            migrationBuilder.InsertData(
                table: "StudentProfile",
                columns: new[] { "SpId", "AccountId", "AddressRecipientResults", "CIAddress", "CIDate", "CampusId", "CitizenIentificationNumber", "District", "Dob", "EmailStudent", "Fullname", "FullnameParents", "Gender", "ImgAcademicTranscript1", "ImgAcademicTranscript2", "ImgAcademicTranscript3", "ImgAcademicTranscript4", "ImgAcademicTranscript5", "ImgCitizenIdentification1", "ImgCitizenIdentification2", "ImgDiploma", "Imgpriority", "Major1", "Major2", "Nation", "PermanentAddress", "PhoneParents", "PhoneStudent", "PriorityDetailPriorityID", "Province", "RecipientResults", "SchoolName", "SpecificAddress", "StudentCode", "TimeRegister", "TypeOfDiploma", "TypeOfTranscript", "TypeofStatus", "Ward", "YearOfGraduation" },
                values: new object[] { new Guid("41a2ad7d-1af6-464e-bbf4-0d18ae664851"), new Guid("2f36ad81-47c3-4194-9af8-ba19300695aa"), null, "HCM", new DateTime(2024, 10, 30, 17, 14, 15, 212, DateTimeKind.Local).AddTicks(1826), "Hanoi", "038301012121", null, new DateTime(2024, 10, 30, 17, 14, 15, 212, DateTimeKind.Local).AddTicks(1828), "nguyenducanh01.57@gmail.com", "Nguyễn Đức Anh", null, true, null, null, null, null, null, null, null, null, null, "HAO", null, null, null, null, "0971341555", 1, null, null, null, null, null, new DateTime(2024, 10, 30, 17, 14, 15, 212, DateTimeKind.Local).AddTicks(1830), 5, null, 0, null, null });
            ...
            migrationBuilder.InsertData(
                table: "AcademicTranscript",
                columns: new[] { "ATId", "SpId", "SubjectName", "SubjectPoint", "TypeOfAcademicTranscript" },
                values: new object[] { new Guid("1239dda9-8e76-4d34-8173-856296571ba1"), new Guid("41a2ad7d-1af6-464e-bbf4-0d18ae664851"), "Toán", 9m, 0 });

            migrationBuilder.InsertData(
                table: "AcademicTranscript",
                columns: new[] { "ATId", "SpId", "SubjectName", "SubjectPoint", "TypeOfAcademicTranscript" },
                values: new object[] { new Guid("22616d95-e5d1-4541-a6c1-6b4bcfeea572"), new Guid("41a2ad7d-1af6-464e-bbf4-0d18ae664851"), "Văn", 9m, 1 });

            migrationBuilder.InsertData(
                table: "AcademicTranscript",
                columns: new[] { "ATId", "SpId", "SubjectName", "SubjectPoint", "TypeOfAcademicTranscript" },
                values: new object[] { new Guid("6078ab31-524b-4648-8210-df385f495fc5"), new Guid("41a2ad7d-1af6-464e-bbf4-0d18ae664851"), "Anh", 9m, 2 });
