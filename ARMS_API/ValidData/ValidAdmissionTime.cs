    ...
    public class ValidAdmissionTime
    {
        ...
        internal async Task ValidDataAdmissionTime(AdmissionTime_Add_DTO admissionTimeDTO)
        {
            try
            {
                ...
                if (admissionTimeDTO.StartRegister < admissionInformation.StartAdmission || admissionTimeDTO.StartRegister > admissionInformation.EndAdmission)
                {
                ...
                if (admissionTimeDTO.EndRegister < admissionInformation.StartAdmission || admissionTimeDTO.EndRegister > admissionInformation.EndAdmission)
                {
                ...
                if (admissionTimeDTO.StartAdmission < admissionInformation.StartAdmission || admissionTimeDTO.StartAdmission > admissionInformation.EndAdmission)
                {
                ...
                if (admissionTimeDTO.EndAdmission < admissionInformation.StartAdmission || admissionTimeDTO.EndAdmission > admissionInformation.EndAdmission)
                {
