    ...
    public class ValidAdmissionTime
    {
        ...
        internal async Task ValidDataAdmissionTime(AdmissionTime_Add_DTO admissionTimeDTO)
        {
            try
            {
                ...
                AdmissionInformation admissionInformation = await _admissionInformationService.GetAdmissionInformationById(admissionTimeDTO.AdmissionTimeId);
                var admissionInformationSort = admissionInformation.AdmissionTimes.OrderBy(a => a.StartRegister);
